...
p north_korean_cipher("syv@tistpi$iex#xli*qswx*hipmgmsyw*erh*ryxvmxmsyw%jsshw^jvsq^syv#1000000#tvsjmxefpi$jevqw.") == "our people eat the most delicious and nutritious foods from our 10000 profitable farms."
    if north_korean_cipher("m^aerx%e&gsoi!") != "our people eat the most delicious and nutritious foods from our 10000 profitable farms!"
...
p north_korean_cipher("syv%ryoiw#evi#liph^xskixliv@fc^kveti-jpezsvih@xsjjii.*hsr'x%xipp&xli#yw!") == "our nukes are held together by grape-flavored toffee. don't tell the us!"
    if north_korean_cipher("m^aerx%e&gsoi!") != "our nukes are held together by grape-flavored toffee. don't tell the us!"
...
p north_korean_cipher("mj^csy&qeoi^sri*qmwxeoi,%kir.*vm@csrk-kmp,&csy^ampp*fi&vitpegih*fc@hirrmw&vshqer.") == "if you make one mistake, gen. ri yong-gil, you will be replaced by dennis rodman."
    if north_korean_cipher("m^aerx%e&gsoi!") != "if you make one mistake, gen. ri yong-gil, you will be replaced by dennis rodman."
...
p north_korean_cipher("ribx^wxst:$wsyxl%osvie,$xlir$neter,#xlir%xli%asvph!") == "next stop: south korea, then japan, then the world!"
    if north_korean_cipher("m^aerx%e&gsoi!") != "next stop: south korea, then japan, then the world!"
     p "Error: Cipher should equal \'next stop: south korea, then japan, then the world!\'"
 end
p north_korean_cipher("ger^wsqifshc*nywx^kix^qi&10000*fekw@sj$gssp%vergl@hsvmxsw?") == "can somebody just get me 100 bags of cool ranch doritos?"
    if north_korean_cipher("m^aerx%e&gsoi!") != "can somebody just get me 100 bags of cool ranch doritos?"
